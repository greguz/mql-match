...
import { isNullish, isPlainObject } from '../util.mjs'
...
export const $isNumber = $operator.bind(null, isNumber)
export const $toBool = $operator.bind(null, toBool)
export const $toDouble = $operator.bind(null, toDouble)
export const $toObjectId = $operator.bind(null, toObjectId)
export const $toString = $operator.bind(null, toString)
export const $type = $operator.bind(null, type)
