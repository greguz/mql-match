...
import { $eq, $ne } from './eq.mjs'

function equals (value) {
  return _compile({ arguments: ['value'], body: `return ${$eq('value', value)}` })
}

function notEquals (value) {
  return _compile({ arguments: ['value'], body: `return ${$ne('value', value)}` })
}
