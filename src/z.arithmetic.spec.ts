    ...
    [
      {
        _id: 1,
        item: 'abc',
        dateDifference: now.getTime() - documents[0].date.getTime(),
      },
      {
        _id: 2,
        item: 'jkl',
        dateDifference: now.getTime() - documents[1].date.getTime(),
      },
    ],
  )
  t.deepEqual(
